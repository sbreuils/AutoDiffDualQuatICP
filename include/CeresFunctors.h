...
struct AutoDiffPbSolvingDualQuaternionsWithWeights {
    ...
    AutoDiffPbSolvingDualQuaternionsWithWeights(const int nbVertices, std::vector<double> vertices,
                                                std::vector<double> normal, std::vector<double> ptil,
                                                std::vector<double> weights, std::vector<int> indices, const int id)
            : Nvertex(nbVertices),
              _vertices(vertices),
              _normal(normal),
              _ptilde(ptil),
    ...
    template<typename Q>
    bool operator()(const Q *const x1, const Q *const x2, const Q *const x3, const Q *const x4, const Q *const x5,
                    Q *residual) const {
        int tot_matches = 0;
        float error = 0.0f;

        DualQuaternionScalar<Q> Transfo1 = DualQuaternionScalar<Q>(make_Scalar3<Q>((Q) x1[0], (Q) x1[1], (Q) x1[2]),
                                                                   make_Scalar3<Q>((Q) x1[3], (Q) x1[4],
                                                                                   (Q) x1[5]));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));

        DualQuaternionScalar<Q> Transfo2 = DualQuaternionScalar<Q>(make_Scalar3<Q>((Q) x2[0], (Q) x2[1], (Q) x2[2]),
                                                                   make_Scalar3<Q>((Q) x2[3], (Q) x2[4],
                                                                                   (Q) x2[5]));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));

        DualQuaternionScalar<Q> Transfo3 = DualQuaternionScalar<Q>(make_Scalar3<Q>((Q) x3[0], (Q) x3[1], (Q) x3[2]),
                                                                   make_Scalar3<Q>((Q) x3[3], (Q) x1[4],
                                                                                   (Q) x3[5]));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));

        DualQuaternionScalar<Q> Transfo4 = DualQuaternionScalar<Q>(make_Scalar3<Q>((Q) x4[0], (Q) x4[1], (Q) x4[2]),
                                                                   make_Scalar3<Q>((Q) x4[3], (Q) x4[4],
                                                                                   (Q) x4[5]));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));

        DualQuaternionScalar<Q> Transfo5 = DualQuaternionScalar<Q>(make_Scalar3<Q>((Q) x5[0], (Q) x5[1], (Q) x5[2]),
                                                                   make_Scalar3<Q>((Q) x5[3], (Q) x5[4],
                                                                                   (Q) x5[5]));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));


        DualQuaternionScalar<Q> point = DualQuaternionScalar<Q>(QuaternionScalar<Q>((Q) 0.0, (Q) 0.0, (Q) 0.0, (Q) 1.0),
                                                                QuaternionScalar<Q>((Q) _vertices[3 * (_idx)],
                                                                                    (Q) _vertices[3 * (_idx) + 1],
                                                                                    (Q) _vertices[3 * (_idx) + 2],
                                                                                    (Q) 0.0));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));
        DualQuaternionScalar<Q> pointN = DualQuaternionScalar<Q>(
                QuaternionScalar<Q>((Q) 0.0, (Q) 0.0, (Q) 0.0, (Q) 1.0),
                QuaternionScalar<Q>((Q) _normal[3 * (_idx)], (Q) _normal[3 * (_idx) + 1], (Q) _normal[3 * (_idx) + 2],
                                    (Q) 0.0));//QuaternionScalar<Q>(Q(0.0),Q(0.0),Q(0.0),Q(0.0));
        ...
        DualQuaternionScalar<Q> Transfo = DualQuaternionScalar<Q>(
                QuaternionScalar<Q>((Q) 0.0, (Q) 0.0, (Q) 0.0, (Q) 0.0),
                QuaternionScalar<Q>((Q) 0.0, (Q) 0.0, (Q) 0.0, (Q) 0.0));

        Transfo = Transfo + Transfo1 * ((Q) _weights[5 * (_idx) +
                                                     0]); //OuterShell.Warp()[_indices[5*(_idx)+v]]*OuterShell.Weights()[5*(_idx)+v];
        ...
        std::cout << "ptilde  (" << _idx << ") = " << _ptilde[3 * _idx] << "-> " << _ptilde[3 * _idx + 1] << ", "
                  << _ptilde[3 * _idx + 2] << "; " << std::endl;

        residual[0] = (vtx.x - _ptilde[3 * _idx]);
        residual[1] = (vtx.y - _ptilde[3 * _idx + 1]);
        residual[2] = (vtx.z - _ptilde[3 * _idx + 2]);

        std::cout << "residual (" << _idx << ") = " << residual[0] << " (x)" << residual[1] << " (y)" << residual[2]
                  << " (z)" << std::endl;
...
/// A CostFunction implementing analytically the Jacobian
